...
class AccountRegisterPayments(models.TransientModel):
    ...
    #qx_check_number = fields.Integer(string="Check Number")
    check_number = fields.Integer(string="Check Number", readonly=False, copy=False, default=0,
    #check_number = fields.Integer(string="Check Number", readonly=True, copy=False, default=0, --original
...
class AccountPayment(models.Model):
    ...
    check_manual_sequencing = fields.Boolean(related='journal_id.check_manual_sequencing', readonly=1)
    check_number = fields.Integer(string="Check Number", readonly=False, copy=False, default=0,
    #check_number = fields.Integer(string="Check Number", readonly=True, copy=False, --orginal
