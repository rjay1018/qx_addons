...
class Employee(models.Model):
    ...
    sssid = fields.Char('SSS No.', help='Social Security System Number', groups="hr.group_hr_user")
    tinid = fields.Char('TIN No.', help='Tax Identification Number', groups="hr.group_hr_user")
    philhealthid = fields.Char('PhilHealth No.', groups="hr.group_hr_user")
    pagibigid = fields.Char('Pag-Ibig No.', groups="hr.group_hr_user")
    identification_id = fields.Char(string='Identification No.', groups="hr.group_hr_user")
    driversid = fields.Char('Driver''s license No.', groups="hr.group_hr_user")
